...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "generator_static_int8"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0xf3df133cd2039771f9aa59b82a466f27"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0x162344d6c18cf994)
...
#define STAI_NETWORK_IN_1_SHAPE       {1,8,12,12}
#define STAI_NETWORK_IN_1_BATCH       (1)
#define STAI_NETWORK_IN_1_HEIGHT      (8)
#define STAI_NETWORK_IN_1_WIDTH       (12)
#define STAI_NETWORK_IN_1_CHANNEL     (12)
#define STAI_NETWORK_IN_1_RANK        (3)
#define STAI_NETWORK_IN_1_SIZE        (1152)
#define STAI_NETWORK_IN_1_SIZE_BYTES  (1152)
#define STAI_NETWORK_IN_1_SCALE       (0.03618268296122551f)
...
#define STAI_NETWORK_IN_2_SHAPE       {1,512}
#define STAI_NETWORK_IN_2_BATCH       (1)
#define STAI_NETWORK_IN_2_CHANNEL     (512)
#define STAI_NETWORK_IN_2_RANK        (1)
#define STAI_NETWORK_IN_2_SIZE        (512)
#define STAI_NETWORK_IN_2_SIZE_BYTES  (512)
#define STAI_NETWORK_IN_2_SCALE       (0.0013926321407780051f)
#define STAI_NETWORK_IN_2_ZERO_POINT  (0)

/*****************************************************************************/
/*  Macros to declare output buffers characteristics  */
#define STAI_NETWORK_OUT_NUM             (1)
#define STAI_NETWORK_OUT_SIZE_BYTES      (110596)
...
#define STAI_NETWORK_OUT_1_SHAPE       {1,3,96,96}
#define STAI_NETWORK_OUT_1_BATCH       (1)
#define STAI_NETWORK_OUT_1_CHANNEL     (3)
#define STAI_NETWORK_OUT_1_HEIGHT      (96)
#define STAI_NETWORK_OUT_1_WIDTH       (96)
#define STAI_NETWORK_OUT_1_RANK        (3)
#define STAI_NETWORK_OUT_1_SIZE        ((96 * 3 * 96))
#define STAI_NETWORK_OUT_1_SIZE_BYTES  (110592)

/*****************************************************************************/
/*  Macros to declare activations buffers characteristics  */
#define STAI_NETWORK_ACTIVATIONS_SIZE              (7373408)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (7373408)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (7373408)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (7373408)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (12248936)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (12248936)
...
#define STAI_NETWORK_WEIGHT_1_SIZE        (12248936)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (12248936)
